...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form class="validate-form" action="{{ route('admin.category.save') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card ">
                    	...
                    	<div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="range" id="range" class="form-control @error('range') is-invalid @enderror" value="{{ old('range') }}" autocomplete="off">
                                    @error('range')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
